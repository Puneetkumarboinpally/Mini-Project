      ...
      <div className="p-6 bg-secondary rounded-lg shadow-lg sm:flex gap-2 ">
        ...
        <div className="flex flex-col justify-around items-center gap-2 lg:gap-4">
          <h1 className="font-bold text-xl text-center">
            <span className="spin">🌸</span>Will you go on a Date with me?
          ...
          <div className="flex gap-6">
            ...
            <button
              className="border py-2 px-6 font-bold rounded active:scale-95 cursor-pointer
             shadow-md text-lg bg-transparent border-2 border-primary text-primary transition-all
             duration-300 hover:"
            >
              No 🥺
            </button>
